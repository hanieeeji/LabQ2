        ...
        $.ajax({
            ...
            success: function (mydata) {
                ...
                if (myData.status === 1) {
                    ...
                    document.getElementById("jobtitle").value = myData.jobtitle;
                    document.getElementById("id").value = myData.id;
                    document.getElementById("email12").value = myData.email;
                    document.getElementById("extension").value = myData.extension;
                }
